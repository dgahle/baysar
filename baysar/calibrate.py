...
def get_pixel_centre(spectra, wavelengths, reference, window=None, instrument_function=None):
    if window is None:
...
def calibrate_spectra(spectra, wavelengths, references, window=None, instrument_function=None):
    """
    ...
    for ref in references:
        ref_pixel=get_pixel_centre(spectra, wavelengths, ref, window, instrument_function)
