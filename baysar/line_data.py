...
line_data['D']['0']['3834.34'] = {'wavelength': 3834.34, 'jj_frac': 1, 'n_upper': 9,
     'exc_tec': os.path.expanduser('~/baysar/data/balmer/neutral_exc_tec_406_grid_h0_5_3970.sav'),
     'rec_pec': os.path.expanduser('~/baysardata/balmer/pec_grid_h0_7_3835.sav'),
     'tec': os.path.expanduser('~/baysar/data/balmer/tec_grids/'
...
line_data['D']['0']['4100.61'] = {'wavelength': 4100.61, 'jj_frac': 1, 'n_upper': 6,
    'exc_tec': os.path.expanduser('~/baysar/data/balmer/neutral_exc_tec_406_grid_h0_4_4101.sav'),
...
line_data['N']['1']['3995.0'] = {'wavelength': 3995.0,  'jj_frac': 1,
             'tec': os.path.expanduser('~/BaySAR/data/n_data/tec_grids/'
...
line_data_multiplet['N']['effective_charge_406'] = os.path.expanduser('~/baysar/data/n_data/effective_charge_406_grid_n.sav')
...
line_data_multiplet['N']['1']['3995.0'] = {'wavelength': 3995.0,  'jj_frac': 1,
             'tec': os.path.expanduser('~/baysar/data/n_data/tec_grids/tec_406_grid_n1_3_3996.sav') }

line_data_multiplet['N']['1']['[4026.09, 4039.35]'] = {'wavelength': [4026.09, 4039.35],  'jj_frac': [0.944, 0.056],
             'tec': os.path.expanduser('~/baysar/data/n_data/tec_grids/tec_406_grid_n1_6_4031.sav') }
...
line_data_multiplet['N']['1']['[4035.09, 4041.32, 4043.54, 4044.79, 4056.92]'] = \
            {'wavelength': [4035.09, 4041.32, 4043.54, 4044.79, 4056.92],
             ...
             'tec': os.path.expanduser('~/baysar/data/n_data/tec_grids/tec_406_grid_n1_7_4042.sav') }
...
line_data_multiplet['N']['1']['[4601.48, 4607.16, 4613.87, 4621.39, 4630.54, 4643.08]'] = \
            {'wavelength': [4601.48, 4607.16, 4613.87, 4621.39, 4630.54, 4643.08],
             ...
             'tec': os.path.expanduser('~/baysar/data/n_data/tec_grids/tec_406_grid_n1_42_4624.sav') }
...
line_data_multiplet['N']['2']['[3998.63, 4003.58]'] = \
    {'wavelength': [3998.63, 4003.58], 'jj_frac': [0.375, 0.625],
     'tec': os.path.expanduser('~/baysar/data/n_data/tec_grids/tec_406_grid_n2_6_4003.sav')}


line_data_multiplet['N']['2']['[4097.33, 4103.34]'] = \
    {'wavelength': [4097.33, 4103.34], 'jj_frac': [0.667, 0.333],
     'tec': os.path.expanduser('~/baysar/data/n_data/tec_grids/tec_406_grid_n2_11_4101.sav') }

line_data_multiplet['N']['2']['[4591.98, 4610.55, 4610.74]'] = \
    {'wavelength': [4591.98, 4610.55, 4610.74], 'jj_frac': [0.312, 0.245, 0.443],
     'tec': os.path.expanduser('~/baysar/data/n_data/tec_grids/tec_406_grid_n2_35_4604.sav') }
