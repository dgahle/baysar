...
def ionisation_balance_transport_test(element: str, tau: float = 0.01, tolerance: float = 1e-10) -> None:
    ...
    # Calculate errors
    f_ion_diff: DataArray = abs(fractional_abundance - fractional_abundance_transport.interp(tau=tau))
